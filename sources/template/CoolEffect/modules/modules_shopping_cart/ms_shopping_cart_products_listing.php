...
// Push all attributes information in an array
        ...
        for ($i=0, $n=\count($products); $i<$n; $i++) {
          ...
          <div class="modal fade ' . $remove_product_id[$i] . '" tabindex="-1" role="dialog" aria-labelledby="' . $remove_product_id[$i] . '" aria-hidden="true" id="' . $remove_product_id[$i] . '">
...
// do the exact qty in function the customer group and product
          ...
          $cart .='<p id="ShoppingCartProductsName" class="nomargin text-start">' . $ticker . ' ' .  $products_name . ' ' . $total_overall_reviews . '</p>';
