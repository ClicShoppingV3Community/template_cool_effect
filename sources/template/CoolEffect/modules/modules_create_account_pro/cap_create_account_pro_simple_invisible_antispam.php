  ...
  class cap_create_account_pro_simple_invisible_antispam {
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_ACCOUNT_PRO_SIMPLE_INVISIBLE_ANTISPAM_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_ACCOUNT_PRO_SIMPLE_INVISIBLE_ANTISPAM_SORT_ORDER',
    ...
    public function keys() {
      return ['MODULES_CREATE_ACCOUNT_PRO_SIMPLE_INVISIBLE_ANTISPAM_STATUS',
              'MODULES_CREATE_ACCOUNT_PRO_SIMPLE_INVISIBLE_ANTISPAM_SORT_ORDER'
             ];
    }
  }
