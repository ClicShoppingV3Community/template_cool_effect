      ...
      <div class="row">
          <span class="col-md-2 col-sm-12">
              <div class="row">
                ...
                <span class="col-md-6 col-sm-12 float-end text-start headerMultiTemplateDefaultLanguage">
                  <ul>
          ...
          <span class="col-md-5 col-sm-6 text-end"><?php echo $banner_header; ?></span>
          <span class="col-md-5 text-end headerMultiTemplateDefaultTitle">
<?php
...
?>
          <span class="col-md-1 col-sm-12 text-end"><?php echo HTML::link(CLICSHOPPING::link(null, 'Info&Contact'), CLICSHOPPING::getDef('modules_header_multi_template_title_contact_us')); ?></span>
      </div>
      <div class="separator"></div>
      <div class="row col-md-12">
          <span class="col-md-3 col-sm-12 text-center headerMultiTemplateDefaultLogo"><?php echo $logo_header; ?></span>
          <span class="col-md-6 col-sm-12 text-center">
              ...
              <div class="input-group col-md-12 advancedSearchCriteria">
                ...
                <span id="buttonKeywordsSearch"><label for="buttonKeywordsSearch"><?php echo HTML::button(null, 'bi bi-search', null, 'primary', null, 'md'); ?></label></span>
              </div>
          ...
          <span class="col-md-3 float-end text-end headerMultiTemplateDefaultCartLink">
<?php
if ($CLICSHOPPING_ShoppingCart->getCountContents() > 0) {
  ?>
    <ul>
          <li class="dropdown headerMultiTemplateDefaultShoppingCart">
            <a class="dropdown-toggle headerMultiTemplateDefaultShoppingCart" data-bs-toggle="dropdown" href="#"><?php echo '<i class="bi bi-cart-fill text-warning headerMultiTemplateDefaultShoppingCart" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;' . $shopping_cart ?></a>
