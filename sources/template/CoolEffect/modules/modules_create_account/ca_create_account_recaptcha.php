  ...
  class ca_create_account_recaptcha {
    ...
    public function execute() {
      ...
      if (isset($_GET['Account']) && isset($_GET['Create']) && !isset($_GET['Success'])) {
       $content_width = (int)MODULES_CREATE_ACCOUNT_RECAPTCHA_CONTENT_WIDTH;
        ...
        $create_account_recaptcha .= '<!-- create_account_recaptcha end -->' . "\n";

        $CLICSHOPPING_Template->addBlock($create_account_recaptcha, $this->group);
      }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_ACCOUNT_RECAPTCHA_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_ACCOUNT_RECAPTCHA_CONTENT_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_ACCOUNT_RECAPTCHA_SORT_ORDER',
    ...
    public function keys() {
      return array('MODULES_CREATE_ACCOUNT_RECAPTCHA_STATUS',
                 'MODULES_CREATE_ACCOUNT_RECAPTCHA_CONTENT_WIDTH',
                 'MODULES_CREATE_ACCOUNT_RECAPTCHA_SORT_ORDER'
                );
    }
  }
