...
//               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DELETE_BUY_BUTTON, $products_id);
              $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DELETE_BUY_BUTTON, $products_id, 'far fa-eye fa-2x', 'link', null, 'sm');
