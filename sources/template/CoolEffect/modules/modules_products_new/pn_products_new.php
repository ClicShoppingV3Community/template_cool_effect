...
// display number of short description
            $products_short_description_number = (int)MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_PRODUCTS_NEW_COLUMNS;
...
//               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_NEW_DELETE_BUY_BUTTON, $products_id);
              $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_NEW_DELETE_BUY_BUTTON, $products_id, 'far fa-eye fa-2x', 'link', null, 'sm');
// Display the image
