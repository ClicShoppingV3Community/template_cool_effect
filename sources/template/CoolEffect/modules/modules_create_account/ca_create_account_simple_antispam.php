  ...
  class ca_create_account_simple_antispam {
    ...
    public function execute() {
      ...
      if (isset($_GET['Account']) && isset($_GET['Create']) && !isset($_GET['Success'])) {
        $content_width = (int)MODULES_CREATE_ACCOUNT_SIMPLE_ANTISPAM_CONTENT_WIDTH;

        $antispam = AntispamClass::getConfirmationSimpleAntiSpam();
        $create_account_antispam = '<!--  create_account_antispam start -->' . "\n";

        ob_start();
        require_once($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/create_account_simple_antispam'));
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_ACCOUNT_SIMPLE_ANTISPAM_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_ACCOUNT_SIMPLE_ANTISPAM_CONTENT_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULES_CREATE_ACCOUNT_SIMPLE_ANTISPAM_SORT_ORDER',
    ...
    public function keys() {
      return ['MODULES_CREATE_ACCOUNT_SIMPLE_ANTISPAM_STATUS',
              'MODULES_CREATE_ACCOUNT_SIMPLE_ANTISPAM_CONTENT_WIDTH',
              'MODULES_CREATE_ACCOUNT_SIMPLE_ANTISPAM_SORT_ORDER'
             ];
    }
  }
