...
// Requetes SQL pour afficher les nouveaux produits groupe B2B lorsque l'on ne ce trouve pas dans une categorie
            ...
            $Qproduct->bindint(':products_limit', (int)MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_MAX_DISPLAY);
            $Qproduct->execute();
          } else {
// Requetes SQL pour afficher les nouveaux produits groupe B2B lorsque l'on se trouve dans une categorie
            ...
            $Qproduct->bindint(':products_limit', MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_MAX_DISPLAY);
            $Qproduct->execute();
          }
...
// display number of short description
            $products_short_description_number = (int)MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('xs');

// Template define
            $filename = $CLICSHOPPING_Template-> getTemplateModulesFilename($this->group .'/template_html/' . MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_TEMPLATE);

            $new_prods_content = '<!-- New Products favorites Start -->' . "\n";
            $new_prods_content .= '<div class="clearfix"></div>';

            if (MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_FRONT_TITLE == 'True') {
              $new_prods_content .= '<div class="page-title ModuleFrontPageProductsFavoritesHeading"><h2>' . sprintf(CLICSHOPPING::getDef('module_front_page_products_favorites_heading_title'), strftime('%B')) . '</h2></div>';
            }

            $new_prods_content .= '<div class="d-flex flex-wrap ModuleFrontPageboxContainerProductsFavorites">';
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_FRONT_PAGE_PRODDUCTS_FAVORITES_DELETE_BUY_BUTTON, $products_id);
...
// **************************
              ...
              if (MODULE_FRONT_PAGE_PRODDUCTS_FAVORITES_DELETE_BUY_BUTTON == 'False') {
...
// See the button more view details
               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_FRONT_PAGE_PRODDUCTS_FAVORITES_DELETE_BUY_BUTTON, $products_id);
              $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_FRONT_PAGE_NEW_PRODUCTS_DELETE_BUY_BUTTON, $products_id, 'far fa-eye fa-2x', 'link', null, 'sm');

// Display the image
//              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_IMAGE_MEDIUM, $products_id);
              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage('Medium', $products_id);

// Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_TICKER, $products_id, 'ModulesFrontPageTickerBootstrapTickerSpecial', 'ModulesFrontPageTickerBootstrapTickerFavorite', 'ModulesFrontPageTickerBootstrapTickerFeatured', 'ModulesFrontPageTickerBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_POURCENTAGE_TICKER, $products_id, 'ModulesFrontPageTickerBootstrapTickerPourcentage');
...
// **************************
            ...
            $new_prods_content .= '</div>' . "\n";
             ...
             $new_prods_content .= '<!-- New productsFavorites End -->' . "\n";
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_MAX_DISPLAY',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_SORT_ORDER',
    ...
    public function keys() {
      return array ('MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_STATUS',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_TEMPLATE',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_FRONT_TITLE',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_MAX_DISPLAY',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_COLUMNS',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_SHORT_DESCRIPTION',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_SHORT_DESCRIPTION_DELETE_WORLDS',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_TICKER',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_POURCENTAGE_TICKER',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_DISPLAY_STOCK',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_IMAGE_MEDIUM',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_DELETE_BUY_BUTTON',
                    'MODULE_FRONT_PAGE_PRODUCTS_FAVORITES_SORT_ORDER'
                    );
    }
  }
