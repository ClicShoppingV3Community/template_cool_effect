  ...
  class ps_products_special {
    ...
    public function __construct() {
      ...
      if (defined('MODULE_PRODUCTS_SPECIAL_STATUS')) {
        $this->sort_order = MODULE_PRODUCTS_SPECIAL_SORT_ORDER;
...
//               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_SPECIAL_DELETE_BUY_BUTTON, $products_id);
              $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_SPECIAL_DELETE_BUY_BUTTON, $products_id, 'far fa-eye fa-2x', 'link', null, 'sm');
// Display the image
